...
import { MARKETING_TEMPLATES } from '@/lib/data/masterRepository'
...
export default function StepVisuals({ form, update }) {
  ...
  const applyTemplate = (key) => {
    ...
    update({
      ...
      marketingOverview: MARKETING_TEMPLATES[key] || '',
    })
  }
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Select onValueChange={applyTemplate}>
              ...
              <SelectContent>
                ...
                <SelectItem value="kashmir">Kashmir welcome</SelectItem>
                <SelectItem value="generic">Generic welcome</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <Textarea
